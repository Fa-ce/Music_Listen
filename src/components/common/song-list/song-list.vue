<template>
    <div class="table-list" v-if="musicList.length">
        <b-table stripe :stripe-background-color="getStripeColor">
            ...
            >
                <b-table-tr>
                    <b-table-td width="50px" v-if="lines[0]">序号</b-table-td>
                    <b-table-td width="60px" v-if="lines[1]">播放</b-table-td>
            ...
            <b-table-body slot="body" class="table-body">
                ...
                >
                    ...
                    <b-table-td
                        ...
                        >{{ item.artist }}</b-table-td
                    >
                    <b-table-td v-if="lines[4]">{{ item.album }}</b-table-td>
                    <b-table-td width="120px" v-if="lines[5]">{{
                        item.time
                    }}</b-table-td>
                </b-table-tr>
            </b-table-body>
