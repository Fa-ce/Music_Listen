<template>
    <div :class="playerClass">
        ...
        <div class="player-toggle" :class="[`${'player-toggle-' + theme}`]">
            ...
            <div
                class="player-player-type player-toggle-item"
                @click="toggle()"
            >
                <i
            ...
            <div class="player-tool-lyric" @click="toggleLyric">
                <a href="#" title="歌词"
                    ><i
                        ...
                        :class="[
                            this.isShowLyric ? `${'player-icon-' + theme}` : '',
                        ]"
                /></a>
            </div>
            <div class="player-tool-list" @click="toggleMusicList">
                <a href="#" title="歌单"
                    ><i
                        ...
                        :class="[
                            this.isShowList ? `${'player-icon-' + theme}` : '',
                        ]"
                /></a>
            </div>
        </div>
...
export default {
    ...
    computed: {
        ...
        getCurrentTime() {
            ...
            return (
                formatDate(new Date(this.currentTime * 1000), "mm:ss") ||
                "00:00"
            );
        },
        /**格式化duration => 'mm:dd' */
